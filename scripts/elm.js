				...
				function (taxonomicClusters) {
					return A2(
						...
						function (displayedClusters) {
							return _elm_lang$core$Json_Decode$succeed(
								{distanceClusters: distanceClusters, taxonomicClusters: taxonomicClusters, displayedClusters: displayedClusters});
						});
				});
		}));
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {distanceClusters: a, taxonomicClusters: b, displayedClusters: c};
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'DataClusters':
				...
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$Model, _p1.distanceClusters, _p1.taxonomicClusters, _p1.distanceClusters),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(
					_elm_lang$core$List$length(model.displayedClusters)))
			]));
};
