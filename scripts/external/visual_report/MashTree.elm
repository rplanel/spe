...
defaultModel : Model
defaultModel =
    Model "" ([ [ Nothing ] ]) Nothing Nothing (Species Nothing) "" Nothing
...
update msg model =
    case msg of
        ...
        ChangeRank rank ->
            let
                resRankType =
                    Rank.resultRankOfMaybeRankInfo rank Nothing
...
getDistance baseUrl id =
    let
        url =
            baseUrl ++ "/../results/distance-matrices/" ++ id ++ "-distance-matrix.json"
    in
...
getTaxa baseUrl id =
    let
        url =
            baseUrl ++ "/../results/distance-matrices/" ++ id ++ "-taxa.json"
...
getTree baseUrl id =
    let
        url =
            baseUrl ++ "/../results/trees/json/" ++ id ++ ".json"
