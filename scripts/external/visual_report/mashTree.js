...
var _user$project$Taxonomy$extractRank = F2(
	function (rankName, taxoInfo) {
		var lowerRankName = _elm_lang$core$String$toLower(rankName);
		var _p0 = lowerRankName;
		switch (_p0) {
			case 'oid':
				return function (_) {
					return _.oid;
...
var _user$project$Taxonomy$encodeTaxonomyInfo = function (taxoInfo) {
	var typeNameToValue = function (typeName) {
		return {
			ctor: '_Tuple2',
			_0: typeName,
			_1: _user$project$Taxonomy_Rank$encodeMaybeRank(
				A2(_user$project$Taxonomy$extractRank, typeName, taxoInfo))
		};
	};
	var listEncode = A2(_elm_lang$core$List$map, typeNameToValue, _user$project$Taxonomy_Rank$getAllRankString);
	return _elm_lang$core$Json_Encode$object(listEncode);
};
var _user$project$Taxonomy$encodeTaxonomy = function (taxonomy) {
	var _p1 = taxonomy;
	if (_p1.ctor === 'Empty') {
		return _elm_lang$core$Json_Encode$null;
	} else {
		return _user$project$Taxonomy$encodeTaxonomyInfo(_p1._0);
	}
};
var _user$project$Taxonomy$taxonomyToString = function (taxonomy) {
	var _p2 = taxonomy;
	if (_p2.ctor === 'Ok') {
		return _elm_lang$core$Basics$toString(
			_user$project$Taxonomy$encodeTaxonomy(_p2._0));
	} else {
		return _elm_lang$core$Basics$toString(_p2._0);
	}
};
var _user$project$Taxonomy$TaxonomyInfo = F8(
	function (a, b, c, d, e, f, g, h) {
		return {oid: a, strain: b, species: c, genus: d, family: e, order: f, class_: g, phylum: h};
	});
var _user$project$Taxonomy$decodeTaxonomyInfo = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'phylum',
	_user$project$Taxonomy_Rank$decodeMaybeRank('phylum'),
	_elm_lang$core$Maybe$Nothing,
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'class_',
		...
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'order',
			_user$project$Taxonomy_Rank$decodeMaybeRank('order'),
			_elm_lang$core$Maybe$Nothing,
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'family',
				_user$project$Taxonomy_Rank$decodeMaybeRank('family'),
				_elm_lang$core$Maybe$Nothing,
				A4(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
					'genus',
					...
					A4(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
						'species',
						_user$project$Taxonomy_Rank$decodeMaybeRank('species'),
						_elm_lang$core$Maybe$Nothing,
						A4(
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
							'strain',
							_user$project$Taxonomy_Rank$decodeMaybeRank('strain'),
							_elm_lang$core$Maybe$Nothing,
							A4(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
								'oid',
								_user$project$Taxonomy_Rank$decodeMaybeRank('oid'),
								_elm_lang$core$Maybe$Nothing,
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Taxonomy$TaxonomyInfo)))))))));
var _user$project$Taxonomy$Taxonomy = function (a) {
	return {ctor: 'Taxonomy', _0: a};
};
var _user$project$Taxonomy$constructTaxonomy = function (taxoInfo) {
	return _elm_lang$core$Result$Ok(
...
var _user$project$MashTree$rankOptions = function (model) {
	var rankStr = _user$project$Taxonomy_Rank$typeOfRank(model.rank);
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_Utils.eq(rankStr, rank))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
	...
	var ranks = _user$project$Taxonomy_Rank$getAllRankString;
	return A2(_elm_lang$core$List$map, toOption, ranks);
};
var _user$project$MashTree$distanceMatrixTable = function (matrix) {
	var distanceCol = function (distance) {
		var dist = function () {
			var _p1 = distance;
			if (_p1.ctor === 'Just') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(dist)
				]));
	};
	var distanceRow = function (distances) {
		return A2(
			_elm_lang$html$Html$tr,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$List$map, distanceCol, distances));
	};
	return A2(
	...
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'taxonomy',
				_1: _user$project$Taxonomy$encodeTaxonomy(record.taxonomy)
			}
			]));
};
var _user$project$MashTree$encodeTree = function (record) {
	var children = function () {
		var _p2 = record.children;
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Json_Encode$null;
		} else {
			var _p4 = _p2._0;
			...
			return _elm_lang$core$Native_Utils.eq(
				...
				0) ? _elm_lang$core$Json_Encode$null : _user$project$MashTree$encodeNodes(_p4);
		}
	}();
	var taxon = function () {
		var _p5 = record.taxon;
		if (_p5.ctor === 'Nothing') {
			return _elm_lang$core$Json_Encode$null;
		} else {
			return _user$project$MashTree$encodeTaxa(_p5._0);
		}
	}();
	var length = function () {
		var _p6 = record.length;
		if (_p6.ctor === 'Nothing') {
			return _elm_lang$core$Json_Encode$null;
		} else {
...
var _user$project$MashTree$encodeNodes = function (nodes) {
	var _p7 = nodes;
	var children = A2(_elm_lang$core$List$map, _user$project$MashTree$encodeTree, _p7._0);
...
var _user$project$MashTree$displayErrorMsg = function (model) {
	var _p8 = model.error;
	if (_p8.ctor === 'Nothing') {
		return A2(
...
var _user$project$MashTree$decodeTaxa = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'taxonomy',
	_user$project$Taxonomy$decodeTaxonomy,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'name',
		_elm_lang$core$Json_Decode$string,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$MashTree$displayErrorMsg(model)
			]));
};
		...
		switch (_p11.ctor) {
			...
			case 'FetchSucceed':
						...
						return A2(
							...
							function (d) {
								return _elm_lang$core$Result$toMaybe(
									_elm_lang$core$String$toFloat(d));
							},
							tab);
					},
					_p11._0);
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{clusterDistance: distanceInt}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchFail':
				var _p17 = _p11._0;
				if (_p17.ctor === 'UnexpectedPayload') {
					return A2(
			...
			case 'FetchTreeSucceed':
				var _p18 = _p11._0;
				var rankStr = _user$project$Taxonomy_Rank$typeOfRank(model.rank);
				var jsonTree = _user$project$MashTree$encodeTree(_p18);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tree: _elm_lang$core$Maybe$Just(_p18)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(listCommand)
				};
			default:
				var commandOnRank = function (rank) {
					var _p19 = model.tree;
					if (_p19.ctor === 'Nothing') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									error: _elm_lang$core$Maybe$Just('No tree available'),
									rank: rank
								}),
							_1: _elm_lang$core$Native_List.fromArray(
						...
						var rankStr = _user$project$Taxonomy_Rank$typeOfRank(rank);
						var jsonTree = _user$project$MashTree$encodeTree(_p19._0);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{error: _elm_lang$core$Maybe$Nothing, rank: rank}),
							_1: _elm_lang$core$Native_List.fromArray(
								[
									_user$project$MashTree$drawTree(
									{ctor: '_Tuple2', _0: jsonTree, _1: rankStr})
				...
				var resRankType = A2(_user$project$Taxonomy_Rank$resultRankOfMaybeRankInfo, _p11._0, _elm_lang$core$Maybe$Nothing);
				var _p20 = function () {
					var _p21 = resRankType;
					if (_p21.ctor === 'Ok') {
						return commandOnRank(_p21._0);
					} else {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									error: _elm_lang$core$Maybe$Just(_p21._0),
									rank: _user$project$Taxonomy_Rank$Species(_elm_lang$core$Maybe$Nothing)
								}),
							_1: _elm_lang$core$Native_List.fromArray(
								[_elm_lang$core$Platform_Cmd$none])
						};
...
var Elm = {};
Elm['MashTree'] = Elm['MashTree'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MashTree'], 'MashTree', typeof _user$project$MashTree$main === 'undefined' ? null : _user$project$MashTree$main);
