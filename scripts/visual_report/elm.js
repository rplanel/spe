...
var _user$project$MashTree$Model = F2(
	function (a, b) {
		return {clusterId: a, clusterDistance: b};
	});
...
var _user$project$MashTree$init = {
	ctor: '_Tuple2',
	_0: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$core$Result$Ok(0.0)
				])
			])),
	_1: _user$project$MashTree$getDistance('CL000000')
};
				...
				var distanceInt = A2(
					...
					function (tab) {
						return A2(
							_elm_lang$core$List$map,
							function (d) {
								return _elm_lang$core$String$toFloat(d);
							},
							tab);
					},
					_p1._0);
				var _p2 = A2(_elm_lang$core$Debug$log, 'distance', distanceInt);
				return {
					ctor: '_Tuple2',
...
var _user$project$MashTree$Display = {ctor: 'Display'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$MashTree$Display)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('getTree')
					])),
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(param.kmer))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(param.sketch))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(param.pvalue))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(param.distance))
						]))
				]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Distance Threshold')
									]))
							]))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, row, params))
			]));
};
